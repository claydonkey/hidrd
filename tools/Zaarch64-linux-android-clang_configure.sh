...
export CFLAGS=" -I${ANDROID_PREFIX}/include/python2.7 -DHAVE_IEEEFP_H=0 -DHAVE_SSIZE_T -DPY_FORMAT_SIZE_T=l -DPY_FORMAT_LONG_LONG=ll"
export CFLAGS=" -g -O0  ${CFLAGS} ${LIBXML2_CFLAGS}  -fPIE -fPIC -pie   -I${PREFIX}/include --sysroot=${SYSROOT} -I${SYSROOT}/include -I${PREFIX}/  -L${PREFIX}/sysroot/usr/include -w -Wno-error "
